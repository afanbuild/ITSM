...
namespace Epower.ITSM.Web.Forms
{
    ...
    /// </summary>
    public partial class frm_REQ_DEMAND_Fast : BasePage
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                LoadIssueTemplaties();
                CheckTemp();
                if (CheckRight(Constant.ReqDemandList) == false)
                {
                    cmdOK.Enabled = false;
        ...
        protected void cmdOK_Click(object sender, EventArgs e)
        {
            ...
            Session["ReqDemandShortXml"] = fv.GetXmlObject().InnerXml;
            ...
            templateid = "Fast" + temp.Split("|".ToCharArray())[0];
        ...
        private void CheckTemp()
        {
            ...
            bool flag = AppFieldConfigDP.CheckFlowModel(long.Parse(flowmodelid), 9711);
            if (!flag)
            {
