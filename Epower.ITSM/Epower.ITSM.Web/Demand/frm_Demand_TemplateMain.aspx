<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="frm_Demand_TemplateMain.aspx.cs" Inherits="Epower.ITSM.Web.Demand.frm_Demand_TemplateMain"
    Title="需求请求模板管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0" class="listContent">
        <tr>
