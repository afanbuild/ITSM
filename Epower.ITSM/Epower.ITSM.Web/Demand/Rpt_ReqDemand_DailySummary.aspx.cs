...
{
    public partial class Rpt_ReqDemand_DailySummary : BasePage
    {
        int nLastYear = 0;
        ...
        protected void SetParentButtonEvent()
        {
            ...
            RightEntity reReqDemand = (RightEntity)((Hashtable)Session["UserAllRights"])[Constant.ReqDemandRptDailySummary];
        ...
        private void LoadData()
        {
            ...
            dt = ReportDP.GetDailySummaryForReqDemand(startTime, endTime, lngDeptID, custId);
