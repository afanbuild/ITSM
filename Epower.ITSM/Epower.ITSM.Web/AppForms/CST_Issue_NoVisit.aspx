<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CST_Issue_NoVisit.aspx.cs" Inherits="Epower.ITSM.Web.AppForms.CST_Issue_NoVisit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                   ...
                   <tr  valign="top">
                       <td align="left" style="border-right-style:none;">
                            ...
                            <asp:DropDownList ID="ddlPeriod" runat="server" Width="84px">
                                <asp:ListItem Value="0">一月内</asp:ListItem>
                                <asp:ListItem Value="1">三个月内</asp:ListItem>
                                <asp:ListItem Value="2">6个月内</asp:ListItem>
                                <asp:ListItem Value="3">一年内</asp:ListItem>
                                <asp:ListItem Value="4">全部</asp:ListItem>
                            </asp:DropDownList>
                            <asp:DropDownList ID="DropSQLwSave" runat="server" Width="160px" AutoPostBack="True" onselectedindexchanged="DropSQLwSave_SelectedIndexChanged"></asp:DropDownList>
                            <img class="icon" style="cursor:hand" id="Img2" onclick="Show_SQLWhere();" height="16" src="../Images/ss_01.gif" width="16" title="高级条件查询" />
                        </td>
                   </tr>                   
                </table>
    ...
    <table width="98%" align="center" id="TableSelect" runat="server" visible="false" class="listContent">
        <tr>
    ...
    <table width="98%" align="center" id="tblEmail" runat="server" class="listContent" visible="false">
        <tr>
            <td class="list" align="left">
                <asp:DropDownList ID="ddltEmail" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="ddltEmail_SelectedIndexChanged" Width="100px">
    ...
    <table width="98%" align="center" cellspacing="0" cellpadding="0" border="0">
        <tr id="trShowControlPre" runat="server" style="height:10px;">
            <td height="20" colspan="2" align="right">
                <div style="width: 300px; height:30px; text-align:right; position: relative">
                    <INPUT id="cmdFlowList" type="button" value="创建事件" onclick="javascript:showServiceConfig2('servicClass3')" class="btnClass">
				    <INPUT id="cmdFastList" type="button" value="快速登单" onclick="javascript:showServiceConfig2('servicClass4')" class="btnClass">			
			        <input id="cmdMerge" type="button" value="重复事件" onclick="javascript:showServiceConfig3('servicClass5')" class="btnClass"/>
			        <div id="servicClass3" style=" width:140px;text-align:center;position:absolute;z-index:9999;left:89px;top:20px;display:none;border: 1px solid #111;background-color: #eee;padding: 5px;opacity: 0.85;" onmouseout="mouseOut('servicClass3')" onmouseover="mouseOver('servicClass3')" >			        
			        ...
			        <div id="servicClass4" style="width:140px; text-align:center;position:absolute;z-index:9999;left:160px;top:20px;display:none;border: 1px solid #111;background-color: #eee;padding: 5px;opacity: 0.85;" onmouseout="mouseOut('servicClass4')" onmouseover="mouseOver('servicClass4')" >			        
			            <table class="listContent" >
			                <tr>
			         ...
			         <div id="servicClass5" style=" width:140px;text-align:center;position:absolute;z-index:100;left:160px;top:20px;display:none;border: 1px solid #111;background-color: #eee;padding: 5px;opacity: 0.85;" onmouseout="mouseOut('servicClass5')" onmouseover="mouseOver('servicClass5')" >			        
			            <table class="listContent" >
			                <tr>
            ...
            <td colspan="2" >
                <asp:DataGrid ID="gridUndoMsg" runat="server" Width="100%"  AutoGenerateColumns="False" CssClass="Gridtable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="详细描述">
                            <ItemTemplate>
                                <asp:Label ID="Label1" Text='<%#GetContent(DataBinder.Eval(Container.DataItem,"Content").ToString()) %>' runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn  HeaderText="删除">
                            ...
                            <ItemStyle  HorizontalAlign="Center"></ItemStyle> 
                            <ItemTemplate>                               
                                <input type="button"  class="btnClass1" onmouseover="SetUrl(1);" onclick="javascript:DeleteSelectedFlow('<%#DataBinder.Eval(Container.DataItem, "flowid")%>');" value="删除" />                               
                        ...
                        <asp:TemplateColumn   HeaderText="问题">
                           ...
                           <ItemStyle  HorizontalAlign="Center"></ItemStyle> 
                            <ItemTemplate>
                                <asp:Button ID="btnChange" runat="server" Text="问题" CommandName="Change"
                                    SkinID="btnClass1" OnClientClick="ChnageProblem(this);" />
        ...
        <TR>
			<TD align="center"><asp:Button ID="btnOk" runat="server" OnClick="HidButton_Click" Width="0px" Height="0px"/></TD>
		</TR>
    </table>
