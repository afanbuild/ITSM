...
{
    /// <summary>
    /// OA_Metting_Base 的摘要说明。
    /// </summary>
    public partial class app_pub_normal_form_New : BasePage
    {
        #region 变量声明
        ...
        private void Master_mySetContentReadOnly()
        {
            ...
            if (Ctrdateandtime5.ContralState != eOA_FlowControlState.eHidden)
                Ctrdateandtime5.ContralState = eOA_FlowControlState.eReadOnly;

            if (Ctrdateandtime6.ContralState != eOA_FlowControlState.eHidden)
                Ctrdateandtime6.ContralState = eOA_FlowControlState.eReadOnly;

            if (Ctrdateandtime7.ContralState != eOA_FlowControlState.eHidden)
                Ctrdateandtime7.ContralState = eOA_FlowControlState.eReadOnly;

            if (Ctrdateandtime8.ContralState != eOA_FlowControlState.eHidden)
                Ctrdateandtime8.ContralState = eOA_FlowControlState.eReadOnly;
            ...
            if (CtrFlowRemark2.ContralState != eOA_FlowControlState.eHidden)
                CtrFlowRemark2.ContralState = eOA_FlowControlState.eReadOnly;
            if (CtrFlowRemark3.ContralState != eOA_FlowControlState.eHidden)
                CtrFlowRemark3.ContralState = eOA_FlowControlState.eReadOnly;
            if (CtrFlowRemark4.ContralState != eOA_FlowControlState.eHidden)
                CtrFlowRemark4.ContralState = eOA_FlowControlState.eReadOnly;
        ...
        private XmlDocument Master_myGetFormsValue(long lngActionID, string strActionName)
        {
            ...
            fv.Add("date5", Ctrdateandtime5.dateTime.ToString());
            fv.Add("date6", Ctrdateandtime6.dateTime.ToString());
            fv.Add("date7", Ctrdateandtime7.dateTime.ToString());
            fv.Add("date8", Ctrdateandtime8.dateTime.ToString());
            ...
            fv.Add("remark2", CtrFlowRemark2.Value.Trim());
            fv.Add("remark3", CtrFlowRemark3.Value.Trim());
            fv.Add("remark4", CtrFlowRemark4.Value.Trim());
        ...
        private void InitInterface()
        {
            ...
            {
                txtFlowName.Text = String.Format("{0}_{1}",
                    Session["PersonName"], oFlow.FlowName);
            }
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (row["Date5"].ToString() != "")
                    {
                        Ctrdateandtime5.dateTime = DateTime.Parse(row["Date5"].ToString());
                    }
                    if (row["Date6"].ToString() != "")
                    {
                        Ctrdateandtime6.dateTime = DateTime.Parse(row["Date6"].ToString());
                    }
                    if (row["Date7"].ToString() != "")
                    {
                        Ctrdateandtime7.dateTime = DateTime.Parse(row["Date7"].ToString());
                    }
                    if (row["Date8"].ToString() != "")
                    {
                        Ctrdateandtime8.dateTime = DateTime.Parse(row["Date8"].ToString());
                    }
                    ...
                    CtrFlowRemark2.Value = row["Remark2"].ToString();
                    CtrFlowRemark3.Value = row["Remark3"].ToString();
                    CtrFlowRemark4.Value = row["Remark4"].ToString();
            ...
            //FlowDP.GetOFlowModelID(oFlow.FlowModelID);
            ...
            if (dr1 != null)
            {
                ...
                if (dr1["date5validate"].ToString() == "1")
                {
                    subDate5.Text = dr1["Date5"].ToString();
                }
                else
                {
                    ShowDate5.Visible = false;
                }
                if (dr1["date6validate"].ToString() == "1")
                {
                    subDate6.Text = dr1["Date6"].ToString();
                }
                else
                {
                    ShowDate6.Visible = false;
                }
                if (dr1["date7validate"].ToString() == "1")
                {
                    subDate7.Text = dr1["Date7"].ToString();
                }
                else
                {
                    ShowDate7.Visible = false;
                }
                if (dr1["date8validate"].ToString() == "1")
                {
                    subDate8.Text = dr1["Date8"].ToString();
                }
                else
                {
                    ShowDate8.Visible = false;
                }
                ...
                if (dr1["Remark2validate"].ToString() == "1")
                {
                    subRemark2.Text = dr1["Remark2"].ToString();
                }
                else
                {
                    ShowRemark2.Visible = false;
                }
                if (dr1["Remark3validate"].ToString() == "1")
                {
                    subRemark3.Text = dr1["Remark3"].ToString();
                }
                else
                {
                    ShowRemark3.Visible = false;
                }
                if (dr1["Remark4validate"].ToString() == "1")
                {
                    subRemark4.Text = dr1["Remark4"].ToString();
                }
                else
                {
                    ShowRemark4.Visible = false;
                }
                ...
                Ctrdateandtime5.TextToolTip = dr1["Date5"].ToString();
                Ctrdateandtime6.TextToolTip = dr1["Date6"].ToString();
                Ctrdateandtime7.TextToolTip = dr1["Date7"].ToString();
                Ctrdateandtime8.TextToolTip = dr1["Date8"].ToString();

                CtrFlowRemark1.TextToolTip = dr1["Remark1"].ToString();
                CtrFlowRemark2.TextToolTip = dr1["Remark2"].ToString();
                CtrFlowRemark3.TextToolTip = dr1["Remark3"].ToString();
                CtrFlowRemark4.TextToolTip = dr1["Remark4"].ToString();
                ...
                if (dr1["Date5Must"].ToString() == "1")
                    Ctrdateandtime5.MustInput = true;
                if (dr1["Date6Must"].ToString() == "1")
                    Ctrdateandtime6.MustInput = true;
                if (dr1["Date7Must"].ToString() == "1")
                    Ctrdateandtime7.MustInput = true;
                if (dr1["Date8Must"].ToString() == "1")
                    Ctrdateandtime8.MustInput = true;

                if (dr1["RemarkMust"].ToString() == "1")
                    CtrFlowRemark1.MustInput = true;
                if (dr1["Remark2Must"].ToString() == "1")
                    CtrFlowRemark2.MustInput = true;
                if (dr1["Remark3Must"].ToString() == "1")
                    CtrFlowRemark3.MustInput = true;
                if (dr1["Remark4Must"].ToString() == "1")
                    CtrFlowRemark4.MustInput = true;
                ...
                if (dr1["Date5Show"].ToString() == "1")
                    Ctrdateandtime5.ShowTime = true;
                else
                    Ctrdateandtime5.ShowTime = false;
                if (dr1["Date6Show"].ToString() == "1")
                    Ctrdateandtime6.ShowTime = true;
                else
                    Ctrdateandtime6.ShowTime = false;
                if (dr1["Date7Show"].ToString() == "1")
                    Ctrdateandtime7.ShowTime = true;
                else
                    Ctrdateandtime7.ShowTime = false;
                if (dr1["Date8Show"].ToString() == "1")
                    Ctrdateandtime8.ShowTime = true;
                else
                    Ctrdateandtime8.ShowTime = false;
                #endregion
            }
            #endregion
            #region 设定字段属性
