...
{
    public partial class CstGreatRecoverAvgTimeKPI : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            if (type == 0)
                ReportDiv.InnerHtml = FlashCS.MSPublicFlashUrl3D(dt, "nMonth", "MonthDay", "rate", "重大事件平均恢复时间KPI  (单位:小时)", "数量", "月份", "../FlashReoport/Flash/MSLine.swf", "100%", "248", true, 2);
            else
                ReportDiv.InnerHtml = FlashCS.MSPublicFlashUrl3D(dt, "nMonth", "MonthDay", "rate", "重大事件平均恢复时间KPI  (单位:小时)", "数量", "年份", "../FlashReoport/Flash/MSLine.swf", "100%", "248", true, 2);
        }
        #endregion 
