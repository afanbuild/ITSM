<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ChangeStatusKPI.aspx.cs" Inherits="Epower.ITSM.Web.KPI.ChangeStatusKPI" Title="变更处理阶段分布KPI" %>
