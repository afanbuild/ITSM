...
{
    public partial class Frm_EsTBLFileslist : BasePage
    {
        ...
        {
            DataTable dt = ES_TBLFileds.select();
        ...
        protected void dgEs_TBL_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {  //点击查看跳转界面
                Response.Redirect("Frm_EsFilesEdit.aspx?ID=" + e.Item.Cells[0].Text);
            }
        }
        ...
        {
            Response.Redirect("Frm_EsFilesEdit.aspx");
        }
