<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWaittingContent_Recieve.aspx.cs" Inherits="Epower.ITSM.Web.Forms.frmWaittingContent_Recieve" Title="待接收事项-按流程分类"%>
												...
												{ 
													...
													{ 
														if(xmlhttp.responseText=="1")
														{
														    ...
														    window.location = "frmWaittingContent_Recieve.aspx?TypeContent=" + '<%=TypeContent%>'; 
													    }
													} 
												} 
					xmlhttp.send(null); 
                ...
                <table cellpadding="0" width="100%" border="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="listContent">                                                
                            <asp:DataGrid ID="gridIssue" runat="server" CssClass="fixed-grid-border" Width="100%" Visible="false"  CellPadding="1" CellSpacing="1" BorderWidth="1px">
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="NumberNo" HeaderText="事件单号" HeaderStyle-Wrap="false">
                                        <HeaderStyle Width="10%"></HeaderStyle>
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn HeaderText="摘要" ItemStyle-Width="450px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSubject" runat="server" Font-Underline="true" Style="word-wrap: break-word" onmouseout="javascript:hideMe('divShowMessageDetail','none');"
                                                ...
                                                Text='<%#DataBinder.Eval(Container.DataItem, "zhaiyao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
        ...
        <tr id="trChange" runat="server" visible="false">
            <td valign="top" align="center" width="100%">
                <table cellpadding="0" width="100%" border="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="listContent">
                            <asp:DataGrid ID="gridChange" CssClass="fixed-grid-border" runat="server" Width="100%" Visible="False"  CellPadding="1" CellSpacing="1" BorderWidth="1px">
                                <Columns>
                                    <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                                        <HeaderStyle Width="16px"></HeaderStyle>
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundColumn DataField="NumberNo" HeaderText="变更单号" HeaderStyle-Wrap="false">
                                        <HeaderStyle Width="10%"></HeaderStyle>
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn HeaderText="摘要" ItemStyle-Width="450px">
        ...
        <tr id="trByts" runat="server" visible="false">
            <td valign="top" align="center" width="100%">
                <table cellpadding="0" width="100%" border="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="listContent">
                            <asp:DataGrid ID="gridByts" CssClass="fixed-grid-border" runat="server" Width="100%" Visible="False"  CellPadding="1" CellSpacing="1" BorderWidth="1px">
                                <Columns>
                                    <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                                        <HeaderStyle Width="16px"></HeaderStyle>
                                        <ItemTemplate>
        ...
        <tr id="trRelease" runat="server" visible="false">
            <td valign="top" align="center" width="100%">
                <table cellpadding="0" width="100%" border="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="listContent">
                            <asp:DataGrid ID="gridRelease" CssClass="fixed-grid-border" runat="server" Width="100%" Visible="False"  CellPadding="1" CellSpacing="1" BorderWidth="1px">
                                <Columns>
                                    <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                                        <HeaderStyle Width="16px"></HeaderStyle>
                                        <ItemTemplate>
        ...
        <tr id="trOther" runat="server" visible="false">
            <td valign="top" align="center" width="100%">
                <table cellpadding="0" width="100%" border="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="listContent">
                            <asp:DataGrid ID="gridOther" CssClass="fixed-grid-border" runat="server" Width="100%" Visible="False"  CellPadding="1" CellSpacing="1" BorderWidth="1px">
                                <Columns>
                                    <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                                        <HeaderStyle Width="16px"></HeaderStyle>
                                        <ItemTemplate>
