<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWaitRecieveThing.aspx.cs" Inherits="Epower.ITSM.Web.Forms.frmWaitRecieveThing" Title="待接收事项-按流程分类"%>
    ...
    <div id="tabs" style="width: 100%;">
        <ul>
            <table width="100%">
                <tr>
                    <td width="100%">
                        <li id="liIssues" runat="server"><a href="../Forms/frmWaittingContent_Recieve.aspx?TypeContent=Issue&Params=<%=sparams%>">
                            <asp:Label ID="lblIssues" runat="server" Text="事件"></asp:Label>[<font color='red'><%=Issue%></font>]</a></li>
                        <li id="liChange" runat="server"><a href="../Forms/frmWaittingContent_Recieve.aspx?TypeContent=Change&Params=<%=sparams%>">
                            <asp:Label ID="lblChange" runat="server" Text="变更"></asp:Label>[<font color='red'><%=Change%></font>]</a></li>
                        <li id="liByts" runat="server"><a href="../Forms/frmWaittingContent_Recieve.aspx?TypeContent=Byts&Params=<%=sparams%>">
                            <asp:Label ID="lblByts" runat="server" Text="问题"></asp:Label>[<font color='red'><%=Byts%></font>]</a></li>                  
                        <li id="liOther" runat="server"><a href="../Forms/frmWaittingContent_Recieve.aspx?TypeContent=Other&Params=<%=sparams%>">
