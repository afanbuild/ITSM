...
{
    public partial class frmWaittingContent_Recieve : BasePage
    {
        #region 变量申明
            ...
            try
            {
                switch (TypeContent)
                {
                    case "Issue"://事件
                        ...
                        dt = ZHServiceDP.getFlowWorkNow((long)Session["UserID"], 1026, 0);
                    ...
                    case "Change":
                        //变更
                        dt = ZHServiceDP.getFlowWorkNow((long)Session["UserID"], 420, 0);
                    ...
                    case "Byts":
                        //问题
                        dt = ZHServiceDP.getFlowWorkNow((long)Session["UserID"], 210, 0);
                    ...
                    case "Release":
                        // 发布
                        dt = ZHServiceDP.getFlowWorkNow((long)Session["UserID"], 1028, 0);
                    ...
                    case "Other":
                        //其它
                        dt = ZHServiceDP.getFlowWorkNow((long)Session["UserID"], 0, 0);
