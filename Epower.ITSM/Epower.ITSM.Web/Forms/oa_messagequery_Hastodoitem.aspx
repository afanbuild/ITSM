<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="oa_messagequery_Hastodoitem.aspx.cs" Inherits="Epower.ITSM.Web.Forms.oa_messagequery_Hastodoitem" Title="无标题页" %>
...
<%@ Register src="../Controls/ctrmessagequery_Hastodoitem.ascx" tagname="ctrmessagequery_Hastodoitem" tagprefix="uc3" %>
...
<table width="80%" align="center" class="listContent">
	...
	<TR>
		<TD align="center" class="list">
				<uc3:ctrmessagequery_Hastodoitem ID="ctrmessagequery_Hastodoitem1" 
                    runat="server" />
        </TD>
	</TR>
	<TR height="30">
		<TD align="center" class="listTitle"><asp:button id="cmdQuery" CssClass="btnClass" runat="server"  Text="查询" onclick="cmdQuery_Click"></asp:button>&nbsp;
			<asp:Button id="cmdAttention" runat="server" Text="加为关注" CssClass="btnClass" Visible="false" onclick="cmdAttention_Click"></asp:Button></TD>
	</TR>
</table>
<br />
<TABLE width="98%" align="center" cellpadding=0 border=0 cellspacing=0>
<TR>
<TD class="list gridTable">
<asp:datagrid id="gridUndoMsg" runat="server" Width="100%"  AutoGenerateColumns="False">
	<Columns>
		...
		<asp:TemplateColumn HeaderText="关注" Visible="false">
			<HeaderStyle Wrap Width="5%" HorizontalAlign="Center"></HeaderStyle>
			<ItemStyle HorizontalAlign="Center"></ItemStyle>
			<ItemTemplate>
				<asp:CheckBox id="chkAttention" runat="server" Visible="false"></asp:CheckBox>
			</ItemTemplate>
		</asp:TemplateColumn>
