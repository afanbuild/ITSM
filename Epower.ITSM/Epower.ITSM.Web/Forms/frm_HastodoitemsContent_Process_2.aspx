<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_HastodoitemsContent_Process_2.aspx.cs" Inherits="Epower.ITSM.Web.Forms.frm_HastodoitemsContent_Process_2" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr id="trIssue" runat="server" visible="false">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="gridIssue" runat="server" Width="100%" Visible="false" CssClass="gridTable" CellPadding="1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="详细描述" ItemStyle-Width="450px">
                            <ItemTemplate>
                                <asp:Label Visible="false" ID="lblSubject" runat="server" Font-Underline="true" Style="word-wrap: break-word;"
                                    onmouseout="javascript:hideMe('divShowMessageDetail','none');" onmouseover='<%#GetFlowShotInfo(Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "flowid")),Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "appid"))) %>'
                                    Text='<%#DataBinder.Eval(Container.DataItem, "Content") %>'></asp:Label>
                                <a target="_parent" href='<%#GetHrefUrl(Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "MessageID")))%>'
                                    onmouseout="javascript:hideMe('divShowMessageDetail','none');" onmouseover='<%#GetFlowShotInfo(Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "flowid")),Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "appid"))) %>'
                                    runat="server" id="hrzhaiyao">
                                    <%#DataBinder.Eval(Container.DataItem, "Content")%></a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="处理" ItemStyle-HorizontalAlign="Center" Visible="false">
                            <HeaderStyle Width="44"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <input id="Button1" class="btnClass1" onclick='<%#GetUrl(Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "MessageID")))%>'
        ...
        <tr id="trChange" runat="server" visible="false">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="gridChange" runat="server" Width="100%" Visible="False" CellPadding="1"
                    CellSpacing="1" BorderWidth="1px"  CssClass="gridTable" >
                    <Columns>
                        <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                            <HeaderStyle Width="16px"></HeaderStyle>
                            <ItemTemplate>
        ...
        <tr id="trByts" runat="server" visible="false">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="gridByts" runat="server" Width="100%" Visible="False" CellPadding="1"
                    CellSpacing="1" BorderWidth="1px"  CssClass="gridTable" >
                    <Columns>
                        <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                            <HeaderStyle Width="16px"></HeaderStyle>
        ...
        <tr id="trRelease" runat="server" visible="false">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="gridRelease" runat="server" Width="100%" Visible="False" CellPadding="1"
                    CellSpacing="1" BorderWidth="1px"  CssClass="gridTable" >
                    <Columns>
                        <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                            <HeaderStyle Width="16px"></HeaderStyle>
        ...
        <tr id="trKb" runat="server" visible="true">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="DataGrid_Kb" runat="server" Width="100%" Visible="true" CellPadding="1"
                    CellSpacing="1" BorderWidth="1px"  CssClass="gridTable" >
                    <Columns>
                        <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                            <HeaderStyle Width="16px"></HeaderStyle>
                        ...
                        <asp:BoundColumn DataField="Title" HeaderText="知识标题" HeaderStyle-Wrap="false">
                        ...
                        <asp:BoundColumn DataField="RegTime" HeaderText="登记时间" DataFormatString="{0:yyyy-MM-dd H:mm}">
                            <HeaderStyle Width="10%"></HeaderStyle>
                            <ItemStyle Wrap="False" />
                        </asp:BoundColumn>
                        <asp:TemplateColumn HeaderText="处理" ItemStyle-HorizontalAlign="Center" Visible="false">
        ...
        <tr id="trOther" runat="server" visible="false">
            <td valign="top" align="center" width="100%" class="listContent">
                <asp:DataGrid ID="gridOther" runat="server" Width="100%" Visible="False" CellPadding="1"
                    CellSpacing="1" BorderWidth="1px"  CssClass="gridTable" >
                    <Columns>
                        <asp:TemplateColumn HeaderImageUrl="~/Images/Page/heading_status.gif">
                            <HeaderStyle Width="16px"></HeaderStyle>
