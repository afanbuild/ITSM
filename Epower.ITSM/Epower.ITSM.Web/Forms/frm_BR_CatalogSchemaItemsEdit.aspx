<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="frm_BR_CatalogSchemaItemsEdit.aspx.cs" Inherits="Epower.ITSM.Web.Forms.frm_BR_CatalogSchemaItemsEdit"
    Title="服务配置项编辑" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function CheckSchemaValuesStatus()
            {
                    ...
                    var trValues = document.getElementById("SchemaItemsValues");
                     ...
                     else if(ddl.selectedIndex == 3||ddl.selectedIndex == 8)
                     {
    ...
    <script language="javascript" type="text/javascript">
         var id= document.all.<%=ddltitemType.ClientID%>.id;
         var ddl=document.getElementById(id);  
         if(ddl.selectedIndex == 3||ddl.selectedIndex == 8)
         {
             document.getElementById("drCatalog").style.display = "";
         }
    </script>    
