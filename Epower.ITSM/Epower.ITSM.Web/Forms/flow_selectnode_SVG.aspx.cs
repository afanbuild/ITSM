...
namespace Epower.ITSM.Web.Forms
{
	...
	/// </summary>
	public partial class flow_selectnode_SVG : BasePage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            string strFlow = FlowModel.GetFlowModelChart(lngMessageID);
            ...
            {
                tb001.Visible = false;
                xmlXsl.Load(Server.MapPath("../xslt/FlowSelectNode_SVG.xslt"));
            }
            else
            {
                xmlXsl.Load(Server.MapPath("../xslt/FlowNodeSelectHasDone_SVG.xslt"));
            }
            ...
            this.lblXml.Text = writer.ToString();
