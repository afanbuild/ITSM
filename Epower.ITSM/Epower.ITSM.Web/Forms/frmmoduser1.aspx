<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Epower.ITSM.Web.Forms.frmModUser1" Title="Untitled Page" Codebehind="frmmoduser1.aspx.cs" %>
			...
			<TABLE id="Table1" height="300" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR >
					...
					<TABLE id="Table2" width="500" class="listContent">
					        <tr>
					            <td colspan=2 class="listTitleNew" align="center"><uc1:ctrtitle id="CtrTitle1" Title="修改密码" runat="server"></uc1:ctrtitle>
					            </td>
					        </tr>
							<TR>
							...
							<TR class="StatusBarForPop">
								<TD align="center" colSpan="2" class="listTitle"><asp:button id="cmdSave" runat="server" Text="确认" Width="56px" CssClass="btnClass" onclick="cmdSave_Click"></asp:button>&nbsp;&nbsp;
										<INPUT style="WIDTH: 49px; HEIGHT: 20px" type="reset" class="btnClass"
											value="取消"></TD>
							</TR>
						</TABLE>
					</TD>
