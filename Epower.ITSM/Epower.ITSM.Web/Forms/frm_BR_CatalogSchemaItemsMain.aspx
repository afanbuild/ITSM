<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="frm_BR_CatalogSchemaItemsMain.aspx.cs" Inherits="Epower.ITSM.Web.Forms.frm_BR_CatalogSchemaItemsMain"
    Title="常用类别配置项管理" %>
        ...
        <tr>
            ...
            <td class='list' colspan="3">
                <asp:DropDownList ID="ddltitemType" runat="server" Width="152px">
                    ...
                    <asp:ListItem Value="8">复选类型</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>       
        ...
        <tr>
            <td align="center" class="listContent">
                <asp:DataGrid ID="dgEqu_SchemaItems" runat="server" Width="100%" CellPadding="1"
                    CellSpacing="2" BorderWidth="0px" AutoGenerateColumns="False"  CssClass=""  OnItemCommand="dgEqu_SchemaItems_ItemCommand"
