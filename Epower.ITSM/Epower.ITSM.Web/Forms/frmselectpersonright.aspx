<%@ Page language="c#" Inherits="Epower.ITSM.Web.Forms.frmSelectPersonRight" Codebehind="frmSelectPersonRight.aspx.cs" %>
	...
	<HEAD>
		...
		<script language="javascript">
			...
			{			
				...
				//var el2 = window.parent.opener.document.all.lsbStaff;
							     
				i=document.all.lsbStaff.selectedIndex;
				
				window.returnValue = el.options(i).value + "@" + el.options(i).text;
