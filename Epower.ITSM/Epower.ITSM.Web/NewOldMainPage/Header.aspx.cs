    ...
    public partial class Header : BasePage
	{
        ...
        protected string StartPage
        {
            get
            {
                ...
                string sReturn = "NewmainDefine.aspx";
                Session["MainUrl"] = Constant.ApplicationPath + "/NewOldMainPage/NewmainDefine.aspx";
        ...
        public string InitSystemName{ set; get; }
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                //从邮件审批,upt by wxh
                spanTool.Attributes.Add("style", "display:none");
            }
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                {
                    InitSystemName = strTitle;
                    Response.Write("<script>window.top.document.title='" +
                        strTitle + "'</script>");
                }
                if (Session["UserDeptName"].ToString() != "")
                {
                    Label1.Text = Session["PersonName"] + "[" + Session["UserDeptName"] + "]";
                }
                else {
                    Label1.Text = Session["PersonName"].ToString();
                }
