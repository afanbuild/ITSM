...
{
    public partial class frmEquFalseRatio : BasePage
    {
        int nLastYear = 0;
        ...
        private void LoadData()
        {
            ...
            dt = ZHServiceDP.GetEquFalseRatio(strBeginDate, strEndDate, long.Parse(dpdMastShortName.SelectedValue));

            ReportDiv.InnerHtml = FlashCS.PublicFlashUrl2D(dt, "资产故障", "数量", "资产故障率分析图", "", "", "../FlashReoport/Flash/Pie2D.swf", "100%", "248", true, 2);
        }
        ...
        private void ToExcel()
        {
            try
            {
                ...
                hw.WriteLine("<table><tr><td><font size=\"3\">资产故障率分析</font></td></tr></table>");
              ...
              //  this.tdResultChart.RenderControl(hw);
                ...
                Response.AppendHeader("Content-Disposition", "attachment;filename=" + System.Web.HttpUtility.UrlEncode("资产故障率分析", System.Text.Encoding.UTF8) + ".xls");
