<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True"
    CodeBehind="LSAOverTimeReport.aspx.cs" Inherits="Epower.ITSM.Web.AnalsysForms.LSAOverTimeReport"
    Title="事件超期（LSA）列表" %>
            ...
            <td align="left" class="list">
                <asp:DataGrid ID="dgMaterialStat" runat="server" Width="100%" AllowCustomPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Customcode" HeaderText="工号">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="CustName" HeaderText="用户名称">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="CustTime" HeaderText="发生时间">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundColumn>
