...
{
    public partial class Rpt_Qust_Type : BasePage
    {
        ...
        private string frmTitle = "按问题种类统计问题单数";
        ...
        private void LoadData()
        {
            ...
            dtQuestion = ReportDP.GetQuetByType(startTime, endTime);
        ...
        private void bindTalbe()
        {
            ...
            sbGrid.AppendFormat("<td>{0}</td>", "问题类别");
