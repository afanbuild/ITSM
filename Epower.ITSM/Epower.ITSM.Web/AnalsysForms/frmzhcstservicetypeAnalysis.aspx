<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="frmzhcstservicetypeAnalysis.aspx.cs" Inherits="Epower.ITSM.Web.AnalsysForms.frmzhcstservicetypeAnalysis"
    Title="服务量分布分析" %>
            ...
            <td align="left" class="listContent">
                <asp:DataGrid ID="dgTypesCount" runat="server" GridLines="Vertical" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="inumber" HeaderText="数量"></asp:BoundColumn>
                    </Columns>
                </asp:DataGrid>
            </td>
        </tr>
