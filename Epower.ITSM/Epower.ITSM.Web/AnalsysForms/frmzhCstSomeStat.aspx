<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" CodeBehind="frmzhCstSomeStat.aspx.cs" Inherits="Epower.ITSM.Web.AnalsysForms.frmzhCstSomeStat" Title="无标题页" %>
...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0"> 
                    <TR>
						<TD align="center" colspan="2"><uc1:ctrtitle id="CtrTitle1" runat="server" Title="服务量统计"></uc1:ctrtitle></TD>
					</TR>
					<tr>
					    <td class="listTitle" width="15%">
					        <asp:Label ID="labManageOffice" runat="server" Text="请选择楼栋"></asp:Label>
					    </td>
					    <td class="list"><asp:dropdownlist id="dpdManageOffice" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dpdManageOffice_SelectedIndexChanged" ></asp:dropdownlist>
					    </td>
					</tr>
					<TR>
