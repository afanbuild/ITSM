...
{
    public partial class ChangeTypePercentage : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            dt = ChangeDealDP.GetChangeTypePercentage(sWhere);

            ReportDiv.InnerHtml = FlashCS.PublicFlashUrl2D(dt, "ChangeTypeName", "CountNum", "变更类别占比", "", "", "../FlashReoport/Flash/Pie2D.swf", "100%", "248", true, 2);
        ...
        private void ToExcel()
        {
            try
            {
                ...
                hw.WriteLine("<table><tr><td><font size=\"3\">变更类别占比</font></td></tr></table>");
                ...
                Response.AppendHeader("Content-Disposition", "attachment;filename=" + System.Web.HttpUtility.UrlEncode("变更类别占比", System.Text.Encoding.UTF8) + ".xls");
