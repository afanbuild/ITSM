...
{
    public partial class frmCst_IssuesDayCount : BasePage
    {
        ...
        private void LoadData()
        {
            ...
            ReportDiv.InnerHtml = FlashCS.MSPublicFlashUrl3D(dt3, "Name", "按天统计工程师工作量", "数量", "时间", "../FlashReoport/Flash/MSLine.swf", "100%", "248", true, 2);

            DataTable dt2 = FlashCS.rtnTBL(dt, "RegSysDate", "Name", "Num");

            //#region 给页面展示列表添加合计项 2013-5-24 温旭添加  
            
            //dt2.Columns.Add("合计", Type.GetType("System.String"));
            ...
            //    {
            //        if(!dt2.Rows[i][j].ToString().Equals(""))
            //        {
            //            count += Convert.ToInt32(dt2.Rows[i][j].ToString());
            //        }
            //    }
            //    dt2.Rows[i]["合计"] = count;
            //}
