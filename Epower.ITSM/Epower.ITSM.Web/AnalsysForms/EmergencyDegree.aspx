<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EmergencyDegree.aspx.cs" Inherits="Epower.ITSM.Web.AnalsysForms.EmergencyDegree" Title="紧急变更占比" %>

<%@ Register src="../Controls/DeptPickerRight.ascx" tagname="DeptPickerRight" tagprefix="uc4" %>
<%@ Register Src="../Controls/ctrFlowCataDropListNew.ascx" TagName="ctrFlowCataDropListNew" TagPrefix="uc6" %>
...
<script type="text/javascript" language="javascript">
    ...
    <table id="Table1" width="98%" class="listContent" cellpadding="2">
        <tr>
            ...
            <td class="list">
                <uc6:ctrFlowCataDropListNew ID="CtrFCDInstancy" runat="server" RootID="1027" ShowType="2" />
            </td>           
        </tr>
        <tr>
            <td class="listTitleRight">
