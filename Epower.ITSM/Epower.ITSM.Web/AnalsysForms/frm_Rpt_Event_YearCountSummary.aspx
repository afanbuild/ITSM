<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="frm_Rpt_Event_YearCountSummary.aspx.cs" Inherits="Epower.ITSM.Web.AnalsysForms.frm_Rpt_Event_YearCountSummary" %>
...
<%--    <div style="display: none;">
    ...
    <table id="Table1" width="98%" class="listContent" cellpadding="2">
        <tr>  
            ...
            <td class="list" width="35%">                
                <uc9:ServiceStaffMastCust ID="Sjwxr" runat="server" RequestType="IssuesDayCount"  />
            </td>     
        </tr>
    </table>
    <table width="98%">
