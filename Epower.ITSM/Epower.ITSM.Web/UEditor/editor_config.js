...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||window.UEditorURL;//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //屏幕截图配置区
        ,snapscreenHost: window.UEditorServer                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ...
        ,snapscreenServerPort: window.UEditorPort                                    //屏幕截图的server端端口
        ...
        ,initialFrameWidth:window.UEditorFrameWidth  //初始化编辑器宽度,默认1000
        ,initialFrameHeight:window.UEditorFrameHeight  //初始化编辑器高度,默认320
        ...
        ,readonly : window.UEditorReadOnly //编辑器初始化结束后,编辑区域是否是只读的，默认是false
