<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  AutoEventWireup="true" CodeBehind="frmUsersMultSelect.aspx.cs" Inherits="Epower.ITSM.Web.mydestop.frmUsersMultSelect" %>
...
<SCRIPT language="javascript">
		<!--
	        ...
	        {	        
	            ...
	            {
                    try{
                        $(window.opener.document.body).find('.bian:first').val('');
                        //window.opener.document.getElementById("ctl00$ContentPlaceHolder1$UserPickerMult1$txtUser").value = '';	                
                    }catch(e){
                        alert(e.message);
                    };
	                window.close();	                
		...
		-->
            ...
            <div style=" float:left; width:20%;padding-top:18px; overflow:auto;" align="left">
                    <FONT face="宋体">
...
<!--End.-->--%>
		     ...
		     <div style="float:right;width:75%; padding-right:18px; padding-top:18px;" align="right">
...
<TABLE id="Table1" width="98%" class="listContent" cellpadding=0>
    ...
    $(document).ready(function(){
        var node = $('.ctl00_ContentPlaceHolder1_tvDept_1');
        node.css('color','red');
    });
</script>
