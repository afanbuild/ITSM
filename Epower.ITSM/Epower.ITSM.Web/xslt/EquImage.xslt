...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:ms="urn:schemas-microsoft-com:xslt" xmlns:v="urn:schemas-microsoft-com:vml">
  <xsl:template match="/">
    <html>
      ...
      <body style="font-size:9pt;" >
        ...
        <v:group id="flowchartshow" style="position:absolute;width:1000px;height:1000px; top:15px;" coordsize="15000,15000">
  ...
  <xsl:template match="LINK">
    ...
    <xsl:if test="TEXT">     
      <v:Rect filled="f" stroked="f">
        ...
        <xsl:attribute name="style">
          <xsl:text>position:absolute; height:3000; width:2500; left:</xsl:text>
    ...
    <xsl:if test="TEXT2">
      <v:Rect filled="f" stroked="f">
        <xsl:attribute name="style">
          <xsl:text>position:absolute;  height:900; width:2500; left:</xsl:text>
