...
var L_Edit_Text           = "\u7f16\u8f91";//编辑
var L_ViewItem_Text       = "\u67e5\u770b\u9879\u76ee";//查看项目
var L_EditItem_Text       = "\u7f16\u8f91\u9879\u76ee";//编辑项目
var L_EditSeriesItem_Text = "\u7f16\u8f91\u5e8f\u5217";//编辑序列
var L_DeleteItem_Text     = "\u5220\u9664\u9879\u76ee";
var L_DeleteDocItem_Text  = "\u5220\u9664";
var L_ViewProperties_Text = "\u67e5\u770b\u5c5e\u6027";
var L_EditProperties_Text = "\u7f16\u8f91\u5c5e\u6027\u76ee";//编辑属性
...
function AddMenuItems(m, ctx)
{
    ...
    if(typeof(User_Define_MenuItems_1) != "undefined")
    {
		if(User_Define_MenuItems_1(m,ctx))
			return;
	}
	if(typeof(User_Define_MenuItems_2) != "undefined")
    {
		if(User_Define_MenuItems_2(m,ctx))
			return;
	}
	if(typeof(User_Define_MenuItems_3) != "undefined")
    {
		if(User_Define_MenuItems_3(m,ctx))
			return;
	}
	if(typeof(User_Define_MenuItems_4) != "undefined")
    {
		if(User_Define_MenuItems_4(m,ctx))
			return;
	}
	if(typeof(User_Define_MenuItems_5) != "undefined")
    {
		if(User_Define_MenuItems_5(m,ctx))
			return;
	}
	if(typeof(User_Define_MenuItems_6) != "undefined")
    {
		if(User_Define_MenuItems_6(m,ctx))
			return;
	}
    
    
    //AddWorkspaceMenuItem(m, ctx);
			AddMyDefineItem(m,ctx);
}
...
function AddMyDefineItem(m,ctx)
{
	strDisplayText = "\u6211\u7684\u6b4d\u8bd5\u83dc\u5355";
	strAction = "alert('dfff')";
	strImagePath = "";
...
function IMNGetStatusImage(state, showoffline)
{
    ...
    {
        case 0:
            img = "..\\images\\imnon.gif";
        break;      
        case 1:
            if (showoffline)
            {
                img = "..\\images\\imnoff.gif";
            }
            else
            {
        ...
        break;  
        case 2:
            img = "..\\images\\imnaway.gif";
        break;
        case 3:
            img = "..\\images\\imnbusy.gif";
        break;
        case 4:
            img = "..\\images\\imnaway.gif";
        break;
