<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_Equ_HistoryChartView.aspx.cs"
    Inherits="Epower.ITSM.Web.EquipmentManager.frm_Equ_HistoryChartView" %>
...
<body>
	...
	<script type="text/javascript" >
	    if (!$.browser.msie) {
	        window.location.href = "frm_Equ_HistoryChartView_SVG.aspx?id=" + $.query.get('id');
	    }
	</script>
