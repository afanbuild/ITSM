<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Frm_ExtensionsMain.aspx.cs" Inherits="Epower.ITSM.Web.EquipmentManager.Frm_ExtensionsMain" Title="无标题页" %>
        ...
        <tr>
            <td align="center" class="listContent">
                <asp:DataGrid ID="dgEqu_SchemaItems" runat="server" Width="100%" CellPadding="1"
                    CellSpacing="2" BorderWidth="0px" AutoGenerateColumns="False"  
                    OnItemCommand="dgEqu_SchemaItems_ItemCommand"
                    OnItemCreated="dgEqu_SchemaItems_ItemCreated" 
                    OnItemDataBound="dgEqu_SchemaItems_ItemDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField='CHName' HeaderText='配置项名称' ItemStyle-Width="30%"></asp:BoundColumn>
                        <asp:BoundColumn DataField='itemType' HeaderText='类型' ItemStyle-Width="30%">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField='GroupName' HeaderText='所属分组' ItemStyle-Width="30%"> </asp:BoundColumn>
                        ...
                        <asp:TemplateColumn HeaderText="删除">
                            <ItemTemplate>
                                <asp:Button ID="lnkDelete" SkinID="btnClass1" runat="server" Text="删除" CommandName="deleted" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
